...
<center>
<form action="/DisplayUserID" style="width: 300px;" model="ForgetPassword">
		...
		<input type="submit" name="Register" onclick="al()" style="background-color: #0048D9; width: 100%; color: white; border-radius: 5px; padding-top: 5px; padding-bottom: 5px; font-weight: bold;" value="Submit"/>
